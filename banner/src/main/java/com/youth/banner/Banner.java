...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private RelativeLayout indicatorContent;//指示器
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        indicatorContent = (RelativeLayout) view.findViewById(R.id.indicatorContent);
    ...
    public void setMarginBottomIndicator(int margin){
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) indicatorContent.getLayoutParams();

        Resources res = context.getResources();
        layoutParams.bottomMargin= (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, margin, res.getDisplayMetrics());
        indicatorContent.setLayoutParams(layoutParams);
    }
